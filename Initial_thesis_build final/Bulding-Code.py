...
results_data_path = Path("./userData/new_setup")
...
topology["end_date"] = "2022-01-01 23:00"
...
write_network_topology(
    ...
    distances={("hydrogenation_node", "dehydrogenation_node"): 100},
    size_max_value=100
)
...
write_network_topology(
    ...
    distances={("dehydrogenation_node", "hydrogenation_node"): 100},
    size_max_value=100
)
