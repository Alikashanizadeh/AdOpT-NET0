...
results_data_path = Path("./userData/Koersvaste_Partial_Heat_5_Tipical_longer distance1560_small gap")
...
topology["end_date"] = "2022-12-31 23:00"
...
set_node_technologies("import_terminal",
                      new_techs=["Hydrogenation_LOHC","Storage_H2_highP"]
                      )

set_node_technologies("hydrogen_hub",
                      new_techs=["Hydrogenation_LOHC","Dehydrogenation_LOHC","Storage_H2_highP"]
                      )

set_node_technologies("cluster",
                      new_techs=["Dehydrogenation_LOHC","Storage_H2_lowP","Storage_H2_highP"]
                      )

set_node_technologies("industry_1",
                      new_techs=["Dehydrogenation_LOHC","Storage_H2_lowP"],
                      )

set_node_technologies("industry_2",
                      new_techs=["Dehydrogenation_LOHC","Storage_H2_lowP"]
                      )
set_node_technologies("industry_3",
                      new_techs=["Storage_H2_lowP"]
                      )
...
distances = {
    ...
    ("hydrogen_hub", "cluster"): 1560,
    ("cluster", "hydrogen_hub"): 1560,
...
heat_data = {
    "hydrogen_hub": {"limit": 0, "price": 0},
    "cluster": {"limit": 500000, "price": 0},
    "industry_1": {"limit": 500000, "price": 0},
    "industry_2": {"limit": 500000, "price": 0},
}
...
adopt.fill_carrier_data(
    input_data_path,
    value_or_data=500000000,
    columns=["Export limit"],
    carriers=["heat"],
    nodes=["import_terminal", "hydrogen_hub"]
)
...
# temporary initialization of unloaded LOHC (and/or the extra unloaded needed)

adopt.fill_carrier_data(
    input_data_path,
    value_or_data=100000000,
    columns=["Import limit"],
...
# # hydrogen demand at demand node (old)(simple)
# adopt.fill_carrier_data(
#     input_data_path,
#     value_or_data=444.4,
#     columns=["Demand"],
...
# hydrogen demand at demand node (new)
...
adopt.fill_carrier_data(
    input_data_path,
    value_or_data=industry_1_demand,
    columns=["Demand"],
    carriers=["hydrogen"],
    nodes=["industry_1"]
)
...
adopt.fill_carrier_data(
    input_data_path,
    value_or_data=industry_2_demand,
    columns=["Demand"],
    carriers=["hydrogen"],
    nodes=["industry_2"]
)
...
adopt.fill_carrier_data(
    input_data_path,
    value_or_data=industry_3_demand,
    columns=["Demand"],
    carriers=["hydrogen"],
    nodes=["industry_3"]
)
