...
results_data_path = Path("./userData/With electricity price_heat added_new_setup_withloss-highdemand_economic_network+tech")
...
set_node_technologies("hydrogen_hub",
                      new_techs=["Hydrogenation_LOHC","Dehydrogenation_LOHC"]
                      )
