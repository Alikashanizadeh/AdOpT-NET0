...
write_network_topology(
    ...
    distances={
        ("import_hydrogen_node", "hydrogenation_node"): 10,
        ("dehydrogenation_node", "demand_node"): 10
    },
    size_max_value=1000
)
...
write_network_topology(
    ...
    distances={("hydrogenation_node", "dehydrogenation_node"): 10},
    size_max_value=1000
)
...
write_network_topology(
    ...
    distances={("dehydrogenation_node", "hydrogenation_node"): 10},
    size_max_value=1000
)
...
# # simplify built-in hydrogenTruck for debugging
# with open(input_data_path / "period1" / "network_data" / "hydrogenTruck.json", "r") as f:
#     hydrogen_net = json.load(f)
#
# hydrogen_net["size_max"] = 1000
# hydrogen_net["Economics"]["gamma1"] = 0
# hydrogen_net["Economics"]["gamma2"] = 0.001
# hydrogen_net["Economics"]["gamma3"] = 0
# hydrogen_net["Economics"]["gamma4"] = 0
# hydrogen_net["Economics"]["OPEX_variable"] = 0.001
# hydrogen_net["Economics"]["OPEX_fixed"] = 0
#
# # remove extra hidden carrier consumption during debugging
# hydrogen_net["Performance"]["energyconsumption"] = {
#     "hydrogen": {
#         "cons_model": 1,
#         "k_flow": 0,
#         "k_flowDistance": 0
...
# }
#
# with open(input_data_path / "period1" / "network_data" / "hydrogenTruck.json", "w") as f:
#     json.dump(hydrogen_net, f, indent=4)
#
